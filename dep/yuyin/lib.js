...
(function (global) {
    ...
    function mixin(e, t, n, r) {
        return t && eachProp(t, function (t, i) {
            if (n || !hasProp(e, i))
                r && typeof t == 'object' && t && !isArray(t) && !isFunction(t) && !(t instanceof RegExp) ? (e[i] || (e[i] = {}), mixin(e[i], t, n, r)) : e[i] = t;
        }), e;
    }
    function bind(e, t) {
        return function () {
    ...
    function newContext(e) {
        ...
        function b(e) {
            ...
            if (t && isArray(t) && t.length > 1)
                return t.shift(), r.require.undef(e), r.makeRequire(null, { skipMap: !0 })([e]), !0;
        }
        function w(e) {
        ...
        function N() {
            globalDefQueue.length && (apsp.apply(l, [
                l.length,
                0
        ...
        function L() {
            var e, n, i = o.waitSeconds * 1000, u = i && r.startTime + i < new Date().getTime(), f = [], l = [], c = !1, h = !0;
            if (t)
                return;
            ...
            if (u && f.length)
                return e = makeError('timeout', 'Load timeout for modules: ' + f, null, f), e.contextName = r.contextName, T(e);
            h && each(l, function (e) {
                k(e, {}, {});
        ...
        return i = {
            ...
            exports: function (e) {
                e.usingExports = !0;
                if (e.map.isDefine)
                    return e.exports ? c[e.map.id] = e.exports : e.exports = c[e.map.id] = {};
            },
            module: function (e) {
                ...
                if (!this.inited)
                    ...
                    if (this.depCount < 1 && !this.defined) {
                        if (isFunction(o)) {
                            ...
                            if (e)
                                return e.requireMap = this.map, e.requireModules = this.map.isDefine ? [this.map.id] : null, e.requireType = this.map.isDefine ? 'define' : 'require', T(this.error = e);
                        } else
                            s = o;
    ...
    typeof require != 'undefined' && !isFunction(require) && (cfg = require, require = undefined), req = requirejs = function (e, t, n, r) {
        ...
        typeof e != 'string' && (n = t, t = e, e = null), isArray(t) || (n = t, t = null), !t && isFunction(n) && (t = [], n.length && (n.toString().replace(commentRegExp, '').replace(cjsRequireRegExp, function (e, n) {
            t.push(n);
        }), t = (n.length === 1 ? ['require'] : [
            'require',
            'exports',
            'module'
        ]).concat(t))), useInteractive && (r = currentlyAddingScript || getInteractiveScript(), r && (e || (e = r.getAttribute('data-requiremodule')), i = contexts[r.getAttribute('data-requirecontext')])), (i ? i.defQueue : globalDefQueue).push([
            e,
            t,
            n
        ]);
...
}(this), define('common/lib/require', [], function () {
    ...
    function I(e, n, r, i) {
        if (b.acceptData(e)) {
            ...
            if (h && c[h] && (i || c[h].data) || !a || r !== t)
                return h || (f ? e[u] = h = l.pop() || b.guid++ : h = u), c[h] || (c[h] = {}, f || (c[h].toJSON = b.noop)), ('object' == typeof n || 'function' == typeof n) && (i ? c[h] = b.extend(c[h], n) : c[h].data = b.extend(c[h].data, n)), s = c[h], i || (s.data || (s.data = {}), s = s.data), r !== t && (s[b.camelCase(n)] = r), a ? (o = s[n], null == o && (o = s[b.camelCase(n)])) : o = s, o;
        }
    }
    function q(e, t, n) {
        if (b.acceptData(e)) {
    ...
    function rn(e, t) {
        ...
        for (; u > o; o++)
            r = e[o], r.style && (s[o] = b._data(r, 'olddisplay'), n = r.style.display, t ? (s[o] || 'none' !== n || (r.style.display = ''), '' === r.style.display && nn(r) && (s[o] = b._data(r, 'olddisplay', an(r.nodeName)))) : s[o] || (i = nn(r), (n && 'none' !== n || !i) && b._data(r, 'olddisplay', i ? n : b.css(r, 'display'))));
        for (o = 0; u > o; o++)
    ...
    function on(e, t, n, r, i) {
        ...
        for (; 4 > s; s += 2)
            'margin' === n && (o += b.css(e, n + Zt[s], !0, i)), r ? ('content' === n && (o -= b.css(e, 'padding' + Zt[s], !0, i)), 'margin' !== n && (o -= b.css(e, 'border' + Zt[s] + 'Width', !0, i))) : (o += b.css(e, 'padding' + Zt[s], !0, i), 'padding' !== n && (o += b.css(e, 'border' + Zt[s] + 'Width', !0, i)));
        return o;
    }
    function un(e, t, n) {
        var r = !0, i = 'width' === t ? e.offsetWidth : e.offsetHeight, s = qt(e), o = b.support.boxSizing && 'border-box' === b.css(e, 'boxSizing', !1, s);
        if (0 >= i || null == i) {
            if (i = Rt(e, t, s), (0 > i || null == i) && (i = e.style[t]), Jt.test(i))
                return i;
    ...
    function nr(e, t, n) {
        ...
        n.queue || (l = b._queueHooks(e, 'fx'), null == l.unqueued && (l.unqueued = 0, c = l.empty.fire, l.empty.fire = function () {
            ...
            p.overflowX,
            p.overflowY
        ], 'inline' === b.css(e, 'display') && 'none' === b.css(e, 'float') && (b.support.inlineBlockNeedsLayout && 'inline' !== an(e.nodeName) ? p.zoom = 1 : p.display = 'inline-block')), n.overflow && (p.overflow = 'hidden', b.support.shrinkWrapBlocks || h.always(function () {
        ...
        if (s = v.length) {
            ...
            for (i = 0; s > i; i++)
                r = v[i], f = h.createTween(r, m ? u[r] : 0), d[r] = u[r] || b.style(e, r), r in u || (u[r] = f.start, m && (f.end = f.start, f.start = 'width' === r || 'height' === r ? 1 : 0));
        }
    }
    ...
    b.fn = b.prototype = {
        ...
        for ('boolean' == typeof u && (l = u, u = arguments[1] || {}, a = 2), 'object' == typeof u || b.isFunction(u) || (u = {}), f === a && (u = this, --a); f > a; a++)
            if (null != (s = arguments[a]))
                for (i in s)
                    e = u[i], r = s[i], u !== r && (l && r && (b.isPlainObject(r) || (n = b.isArray(r))) ? (n ? (n = !1, o = e && b.isArray(e) ? e : []) : o = e && b.isPlainObject(e) ? e : {}, u[i] = b.extend(l, o, r)) : r !== t && (u[i] = r));
        return u;
    }, b.extend({
    ...
    b.fn.extend({
        ...
        val: function (e) {
            ...
            if (s)
                return r = b.valHooks[s.type] || b.valHooks[s.nodeName.toLowerCase()], r && 'get' in r && (n = r.get(s, 'value')) !== t ? n : (n = s.value, 'string' == typeof n ? n.replace(V, '') : null == n ? '' : n);
        }
    }), b.extend({
        valHooks: {
            option: {
        ...
        attr: function (e, n, r) {
            ...
            if (e && 3 !== a && 8 !== a && 2 !== a)
                return typeof e.getAttribute === i ? b.prop(e, n, r) : (o = 1 !== a || !b.isXMLDoc(e), o && (n = n.toLowerCase(), s = b.attrHooks[n] || (K.test(n) ? W : z)), r === t ? s && o && 'get' in s && null !== (u = s.get(e, n)) ? u : (typeof e.getAttribute !== i && (u = e.getAttribute(n)), null == u ? t : u) : null !== r ? s && o && 'set' in s && (u = s.set(e, r, n)) !== t ? u : (e.setAttribute(n, r + ''), r) : (b.removeAttr(e, n), t));
        },
        ...
        prop: function (e, n, r) {
            ...
            if (e && 3 !== u && 8 !== u && 2 !== u)
                return o = 1 !== u || !b.isXMLDoc(e), o && (n = b.propFix[n] || n, s = b.propHooks[n]), r !== t ? s && 'set' in s && (i = s.set(e, r, n)) !== t ? i : e[n] = r : s && 'get' in s && null !== (i = s.get(e, n)) ? i : e[n];
        },
        propHooks: {
            tabIndex: {
                get: function (e) {
    ...
    })), b.support.hrefNormalized || (b.each([
        'href',
        'src',
        'width',
        'height'
    ...
    })), b.support.enctype || (b.propFix.enctype = 'encoding'), b.support.checkOn || b.each([
        'radio',
        'checkbox'
    ], function () {
        b.valHooks[this] = {
    ...
    b.event = {
        ...
        trigger: function (n, r, i, o) {
            ...
            if (f = h = i = i || s, 3 !== i.nodeType && 8 !== i.nodeType && !nt.test(v + b.event.triggered) && (v.indexOf('.') >= 0 && (m = v.split('.'), v = m.shift(), m.sort()), a = 0 > v.indexOf(':') && 'on' + v, n = n[b.expando] ? n : new b.Event(v, 'object' == typeof n && n), n.isTrigger = !0, n.namespace = m.join('.'), n.namespace_re = n.namespace ? RegExp('(^|\\.)' + m.join('\\.(?:.*\\.|)') + '(\\.|$)') : null, n.result = t, n.target || (n.target = i), r = null == r ? [n] : b.makeArray(r, [n]), c = b.event.special[v] || {}, o || !c.trigger || c.trigger.apply(i, r) !== !1)) {
                if (!o && !c.noBubble && !b.isWindow(i)) {
                    for (l = c.delegateType || v, nt.test(l + v) || (f = f.parentNode); f; f = f.parentNode)
                        d.push(f), h = f;
            ...
            if (a[0] = e, e.delegateTarget = this, !l.preDispatch || l.preDispatch.call(this, e) !== !1) {
                ...
                while ((s = u[n++]) && !e.isPropagationStopped()) {
                    ...
                    while ((i = s.handlers[o++]) && !e.isImmediatePropagationStopped())
                        (!e.namespace_re || e.namespace_re.test(i.namespace)) && (e.handleObj = i, e.data = i.data, r = ((b.event.special[i.origType] || {}).handle || i.handler).apply(s.elem, a), r !== t && (e.result = r) === !1 && (e.preventDefault(), e.stopPropagation()));
                }
        ...
        function ut(e, t, n, r) {
            ...
            if ((t ? t.ownerDocument || t : E) !== c && l(t), t = t || c, n = n || [], !e || 'string' != typeof e)
                return n;
        ...
        function ht(e, t) {
            ...
            while (u) {
                ...
                for (o in i.filter)
                    !(r = V[o].exec(u)) || f[o] && !(r = f[o](r)) || (n = r.shift(), s.push({
                        value: n,
                        type: o,
                        matches: r
                    }), u = u.slice(n.length));
                    ...
                    while (t = t[i])
                        if (1 === t.nodeType || s)
                            if (l = t[w] || (t[w] = {}), (f = l[i]) && f[0] === c) {
                                if ((a = f[1]) === !0 || a === r)
                                    return a === !0;
                            } else if (f = l[i] = [c], f[1] = e(t, n, u) || r, f[1] === !0)
                                return !0;
            };
        }
        function vt(e) {
        ...
        function bt(e, t) {
            var n = 0, s = t.length > 0, o = e.length > 0, u = function (u, a, l, h, p) {
                    var d, v, m, g = [], y = 0, b = '0', w = u && [], E = null != p, S = f, T = u || o && i.find.TAG('*', p && a.parentNode || a), N = x += null == S ? 1 : Math.random() || 0.1;
        ...
        o = ut.isXML = function (e) {
            ...
            return n !== c && 9 === n.nodeType && n.documentElement ? (c = n, h = n.documentElement, p = o(n), S.tagNameNoComments = ot(function (e) {
                ...
                0,
                0
            ].sort(y), S.detectDuplicates = a, c) : c;
        }, ut.matches = function (e, t) {
            return ut(e, null, null, t);
        }, ut.matchesSelector = function (e, t) {
            if ((e.ownerDocument || e) !== c && l(e), t = t.replace(Z, '=\'$1\']'), !(!S.matchesSelector || p || v && v.test(t) || d.test(t)))
                try {
                    var n = m.call(e, t);
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        if (m) {
                            ...
                            if (d = [o ? m.firstChild : m.lastChild], o && y) {
                                ...
                                while (c = ++p && c && c[v] || (h = p = 0) || d.pop())
                                    if ((u ? c.nodeName.toLowerCase() === g : 1 === c.nodeType) && ++h && (y && ((c[w] || (c[w] = {}))[e] = [
                                            x,
                                            h
                                        ]), c === t))
                                        break;
    ...
    Lt.optgroup = Lt.option, Lt.tbody = Lt.tfoot = Lt.colgroup = Lt.caption = Lt.thead, Lt.th = Lt.td, b.fn.extend({
        ...
        remove: function (e, t) {
            var n, r = 0;
            for (; null != (n = this[r]); r++)
                (!e || b.filter(e, [n]).length > 0) && (t || 1 !== n.nodeType || b.cleanData(jt(n)), n.parentNode && (t && b.contains(n.ownerDocument, n) && Pt(jt(n, 'script')), n.parentNode.removeChild(n)));
            return this;
        },
        empty: function () {
            var e, t = 0;
        ...
        html: function (e) {
            return b.access(this, function (e) {
                ...
                if (!('string' != typeof e || St.test(e) || !b.support.htmlSerialize && mt.test(e) || !b.support.leadingWhitespace && gt.test(e) || Lt[(bt.exec(e) || [
                        '',
                        ''
                    ])[1].toLowerCase()])) {
                    e = e.replace(yt, '<$1></$2>');
                    try {
                        for (; i > r; r++)
                            n = this[r] || {}, 1 === n.nodeType && (b.cleanData(jt(n, !1)), n.innerHTML = e);
                        n = 0;
                    } catch (s) {
                    }
                }
        ...
        domManip: function (e, n, r) {
            ...
            if (c && (f = b.buildFragment(e, this[0].ownerDocument, !1, this), i = f.firstChild, 1 === f.childNodes.length && (f = i), i)) {
                for (n = n && b.nodeName(i, 'tr'), u = b.map(jt(f, 'script'), _t), o = u.length; c > l; l++)
                    s = f, l !== d && (s = b.clone(s, !0, !0), o && b.merge(u, jt(s, 'script'))), r.call(n && b.nodeName(this[l], 'table') ? Mt(this[l], 'tbody') : this[l], s, l);
                if (o)
                    for (a = u[u.length - 1].ownerDocument, b.map(u, Dt), l = 0; o > l; l++)
                        s = u[l], Nt.test(s.type || '') && !b._data(s, 'globalEval') && b.contains(a, s) && (s.src ? b.ajax({
                            url: s.src,
                            type: 'GET',
                            dataType: 'script',
                            async: !1,
            ...
            for (; c > d; d++)
                if (s = e[d], s || 0 === s)
                    if ('object' === b.type(s))
                        ...
                        u = u || h.appendChild(t.createElement('div')), a = (bt.exec(s) || [
                            '',
                            ''
                        ])[1].toLowerCase(), l = Lt[a] || Lt._default, u.innerHTML = l[1] + s.replace(yt, '<$1></$2>') + l[2], i = l[0];
                        while (i--)
                            u = u.lastChild;
    ...
    b.fn.extend({
        ...
        style: function (e, n, r, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (n = b.cssProps[a] || (b.cssProps[a] = tn(f, a)), u = b.cssHooks[n] || b.cssHooks[a], r === t)
                    return u && 'get' in u && (s = u.get(e, !1, i)) !== t ? s : f[n];
                if (o = typeof r, 'string' === o && (s = Kt.exec(r)) && (r = (s[1] + 1) * s[2] + parseFloat(b.css(e, n)), o = 'number'), !(null == r || 'number' === o && isNaN(r) || ('number' !== o || b.cssNumber[a] || (r += 'px'), b.support.clearCloneStyle || '' !== r || 0 !== n.indexOf('background') || (f[n] = 'inherit'), u && 'set' in u && (r = u.set(e, r, i)) === t)))
                    try {
                        f[n] = r;
                    } catch (l) {
                    }
        ...
        get: function (e, t) {
            return zt.test((t && e.currentStyle ? e.currentStyle.filter : e.style.filter) || '') ? 0.01 * parseFloat(RegExp.$1) + '' : t ? '1' : '';
        },
        set: function (e, t) {
        ...
        b.support.reliableMarginRight || (b.cssHooks.marginRight = {
            get: function (e, n) {
                return n ? b.swap(e, { display: 'inline-block' }, Rt, [
                    e,
                    'marginRight'
                ]) : t;
            }
        ...
        ajax: function (e, n) {
            function N(e, n, r, i) {
                ...
                2 !== w && (w = 2, u && clearTimeout(u), f = t, o = i || '', x.readyState = e > 0 ? 4 : 0, r && (E = Hn(c, x, r)), e >= 200 && 300 > e || 304 === e ? (c.ifModified && (S = x.getResponseHeader('Last-Modified'), S && (b.lastModified[s] = S), S = x.getResponseHeader('etag'), S && (b.etag[s] = S)), 204 === e ? (l = !0, T = 'nocontent') : 304 === e ? (l = !0, T = 'notmodified') : (l = Bn(c, E), T = l.state, g = l.data, y = l.error, l = !y)) : (y = T, (e || !T) && (T = 'error', 0 > e && (e = 0))), x.status = e, x.statusText = (n || T) + '', l ? d.resolveWith(h, [
                    ...
                    T,
                    y
                ]), x.statusCode(m), m = t, a && p.trigger(l ? 'ajaxSuccess' : 'ajaxError', [
                    x,
                    c,
                    l ? g : y
                ]), v.fireWith(h, [
            ...
            if (d.promise(x).complete = v.add, x.success = x.done, x.error = x.fail, c.url = ((e || c.url || gn) + '').replace(wn, '').replace(Nn, mn[1] + '//'), c.type = n.method || n.type || c.method || c.type, c.dataTypes = b.trim(c.dataType || '*').toLowerCase().match(E) || [''], null == c.crossDomain && (r = Cn.exec(c.url.toLowerCase()), c.crossDomain = !(!r || r[1] === mn[1] && r[2] === mn[2] && (r[3] || ('http:' === r[1] ? 80 : 443)) == (mn[3] || ('http:' === mn[1] ? 80 : 443)))), c.data && c.processData && 'string' != typeof c.data && (c.data = b.param(c.data, c.traditional)), Dn(Ln, c, n, x), 2 === w)
                return x;
                    ...
                    a.send(n.hasContent && n.data || null), r = function (e, i) {
                        ...
                        try {
                            if (r && (i || 4 === a.readyState))
                                if (r = t, o && (a.onreadystatechange = b.noop, Un && delete In[o]), i)
    ...
    b.Animation = b.extend(er, {
        ...
        finish: function (e) {
            return e !== !1 && (e = e || 'fx'), this.each(function () {
                ...
                for (n.finish = !0, b.queue(this, e, []), i && i.cur && i.cur.finish && i.cur.finish.call(this), t = s.length; t--;)
        ...
        setOffset: function (e, t, n) {
            ...
            var i = b(e), s = i.offset(), o = b.css(e, 'top'), u = b.css(e, 'left'), a = ('absolute' === r || 'fixed' === r) && b.inArray('auto', [
                    o,
                    u
                ]) > -1, f = {}, l = {}, c, h;
...
+function (e) {
    ...
    n.VERSION = '3.3.4', n.DEFAULTS = { loadingText: 'loading...' }, n.prototype.setState = function (t) {
        ...
        t += 'Text', null == s.resetText && r.data('resetText', r[i]()), setTimeout(e.proxy(function () {
            r[i](null == s[t] ? this.options[t] : s[t]), 'loadingText' == t ? (this.isLoading = !0, r.addClass(n).attr(n, n)) : this.isLoading && (this.isLoading = !1, r.removeClass(n).removeAttr(n));
        }, this), 0);
    ...
    function t(t) {
        return this.each(function () {
            var r = e(this), i = r.data('bs.carousel'), s = e.extend({}, n.DEFAULTS, r.data(), 'object' == typeof t && t), o = 'string' == typeof t ? t : s.slide;
    ...
    n.VERSION = '3.3.4', n.TRANSITION_DURATION = 600, n.DEFAULTS = {
        ...
        if (r && !this.options.wrap)
            return t;
        var i = 'prev' == e ? -1 : 1, s = (n + i) % this.$items.length;
        ...
        var i = this.$element.find('.item.active'), s = r || this.getItemForDirection(t, i), o = this.interval, u = 'next' == t ? 'left' : 'right', f = this;
        if (s.hasClass('active'))
            return this.sliding = !1;
        var l = s[0], h = e.Event('slide.bs.carousel', {
                relatedTarget: l,
                direction: u
            });
        if (this.$element.trigger(h), !h.isDefaultPrevented()) {
            ...
            return e.support.transition && this.$element.hasClass('slide') ? (s.addClass(t), s[0].offsetWidth, i.addClass(u), s.addClass(u), i.one('bsTransitionEnd', function () {
                s.removeClass([
                    t,
                    u
                ].join(' ')).addClass('active'), i.removeClass([
                    'active',
                    u
                ].join(' ')), f.sliding = !1, setTimeout(function () {
                    f.$element.trigger(d);
                }, 0);
            }).emulateTransitionEnd(n.TRANSITION_DURATION)) : (i.removeClass('active'), s.addClass('active'), this.sliding = !1, this.$element.trigger(d)), o && this.cycle(), this;
        }
    };
    var r = e.fn.carousel;
    ...
    function n(t) {
        return this.each(function () {
            var n = e(this), i = n.data('bs.collapse'), s = e.extend({}, r.DEFAULTS, n.data(), 'object' == typeof t && t);
    ...
    e.fn.collapse = n, e.fn.collapse.Constructor = r, e.fn.collapse.noConflict = function () {
        ...
        var s = t(i), o = s.data('bs.collapse'), u = o ? 'toggle' : i.data();
        n.call(s, u);
    });
}(jQuery), +function (e) {
    function t(t) {
        t && 3 === t.which || (e(i).remove(), e(s).each(function () {
            var r = e(this), i = n(r), s = { relatedTarget: this };
    ...
    o.VERSION = '3.3.4', o.prototype.toggle = function (r) {
        var i = e(this);
        ...
        if (/(38|40|27|32)/.test(t.which) && !/input|textarea/i.test(t.target.tagName)) {
            ...
            if (t.preventDefault(), t.stopPropagation(), !r.is('.disabled, :disabled')) {
                ...
                if (!o && 27 != t.which || o && 27 == t.which)
                    return 27 == t.which && i.find(s).trigger('focus'), r.trigger('click');
                var u = ' li:not(.disabled):visible a', l = i.find('[role="menu"]' + u + ', [role="listbox"]' + u);
                if (l.length) {
    ...
    n.VERSION = '3.3.4', n.TRANSITION_DURATION = 300, n.BACKDROP_TRANSITION_DURATION = 150, n.DEFAULTS = {
        ...
        if (this.isShown && this.options.backdrop) {
            ...
            if (this.$backdrop = e('<div class="modal-backdrop ' + i + '" />').appendTo(this.$body), this.$element.on('click.dismiss.bs.modal', e.proxy(function (e) {
                ...
                }, this)), s && this.$backdrop[0].offsetWidth, this.$backdrop.addClass('in'), !t)
                return;
    ...
    function t(t) {
        return this.each(function () {
            ...
            (i || !/destroy|hide/.test(t)) && (i || r.data('bs.tooltip', i = new n(this, s)), 'string' == typeof t && i[t]());
        });
    }
    var n = function (e, t) {
    ...
    n.VERSION = '3.3.4', n.TRANSITION_DURATION = 150, n.DEFAULTS = {
        ...
        if (this.enabled = !0, this.type = t, this.$element = e(n), this.options = this.getOptions(r), this.$viewport = this.options.viewport && e(this.options.viewport.selector || this.options.viewport), this.$element[0] instanceof document.constructor && !this.options.selector)
        ...
        if (this.hasContent() && this.enabled) {
            ...
            var u = 'function' == typeof this.options.placement ? this.options.placement.call(this, s[0], this.$element[0]) : this.options.placement, f = /\s?auto?\s?/i, l = f.test(u);
            l && (u = u.replace(f, '') || 'top'), s.detach().css({
                top: 0,
                left: 0,
                display: 'block'
            }).addClass(u).data('bs.' + this.type, this), this.options.container ? s.appendTo(this.options.container) : s.insertAfter(this.$element);
            var h = this.getPosition(), p = s[0].offsetWidth, d = s[0].offsetHeight;
            if (l) {
                var v = u, m = this.options.container ? e(this.options.container) : this.$element.parent(), g = this.getPosition(m);
                u = 'bottom' == u && h.bottom + d > g.bottom ? 'top' : 'top' == u && h.top - d < g.top ? 'bottom' : 'right' == u && h.right + p > g.width ? 'left' : 'left' == u && h.left - p < g.left ? 'right' : u, s.removeClass(v).addClass(u);
            }
        ...
        var h = /top|bottom/.test(n), p = h ? 2 * c.left - i + f : 2 * c.top - s + l, d = h ? 'offsetWidth' : 'offsetHeight';
        r.offset(t), this.replaceArrow(p, r[0][d], h);
        ...
        return this.$element.trigger(o), o.isDefaultPrevented() ? void 0 : (s.removeClass('in'), e.support.transition && s.hasClass('fade') ? s.one('bsTransitionEnd', r).emulateTransitionEnd(n.TRANSITION_DURATION) : r(), this.hoverState = null, this);
        ...
        var s = r ? {
                top: 0,
                left: 0
            } : t.offset(), o = { scroll: r ? document.documentElement.scrollTop || document.body.scrollTop : t.scrollTop() }, u = r ? {
    ...
    function t(t) {
        return this.each(function () {
            ...
            (i || !/destroy|hide/.test(t)) && (i || r.data('bs.popover', i = new n(this, s)), 'string' == typeof t && i[t]());
        });
    }
    var n = function (e, t) {
    ...
    n.VERSION = '3.3.4', n.TRANSITION_DURATION = 150, n.prototype.show = function () {
        ...
        var o = r.find('> .active'), u = i && e.support.transition && (o.length && o.hasClass('fade') || !!r.find('> .fade').length);
    ...
    n.VERSION = '3.3.4', n.RESET = 'affix affix-top affix-bottom', n.DEFAULTS = {
        ...
        if ('bottom' == this.affixed)
            return null != n ? i + this.unpin <= s.top ? !1 : 'bottom' : e - r >= i + o ? !1 : 'bottom';
        var u = null == this.affixed, a = u ? i : s.top, f = u ? o : t;
        ...
        if (this.$element.is(':visible')) {
            var t = this.$element.height(), r = this.options.offset, i = r.top, s = r.bottom, o = e(document.body).height();
            'object' != typeof r && (s = i = r), 'function' == typeof i && (i = r.top(this.$element)), 'function' == typeof s && (s = r.bottom(this.$element));
            var u = this.getState(o, t, i, s);
            if (this.affixed != u) {
                null != this.unpin && this.$element.css('top', '');
                var f = 'affix' + (u ? '-' + u : ''), l = e.Event(f + '.bs.affix');
                if (this.$element.trigger(l), l.isDefaultPrevented())
                    return;
                this.affixed = u, this.unpin = 'bottom' == u ? this.getPinnedOffset() : null, this.$element.removeClass(n.RESET).addClass(f).trigger(f.replace('affix', 'affixed') + '.bs.affix');
            }
            'bottom' == u && this.$element.offset({ top: o - t - s });
        }
    };
    var r = e.fn.affix;
    ...
    e.fn.dropdownHover = function (n) {
        return r = r.add(this.parent()), this.each(function () {
            var n = e(this).parent(), i = {
                    delay: 100,
                    instantlyCloseOthers: !0
                }, s = {
                    delay: e(this).data('delay'),
                    instantlyCloseOthers: e(this).data('close-others')
                }, o = e.extend(!0, {}, i, o, s), u;
            n.hover(function () {
                o.instantlyCloseOthers === !0 && r.removeClass('open'), t.clearTimeout(u), e(this).addClass('open');
            }, function () {
...
}(jQuery, this), define('common/lib/bootstrap/js/bootstrap.min', [], function () {
}), requirejs.config({
    baseUrl: window.$CONFIG['paths.static'],
    paths: {
        jquery: 'common/lib/jquery/jquery.min',
        'jquery.validate': 'common/lib/jquery.validate.min',
        'jquery.cookie': 'common/lib/jqcookie-1.4.1/jquery.cookie',
        CodeMirror: 'common/lib/codemirror-4.11/codemirror',
        'jquery.easydropdown': 'common/lib/easydropdown/jquery.easydropdown.min',
        ajaxfileupload: 'common/lib/jqueryfileupload/ajaxfileupload',
        Recorder: 'common/widget/voice/voice.min',
        highcharts: 'common/lib/highchart/highcharts',
        WdatePicker: 'common/lib/My97DatePicker/WdatePicker'
    }
}), define('config', [], function () {
}), define('common/widget/loginpop/loginpop', ['require'], function (e) {
    function t(e) {
        this.obj = e;
    }
    return $.extend(t.prototype, {
        ...
        login: function () {
            var e = window.$CONFIG['paths.base'] + 'resources/v3Jump.html', t = this;
            window.LoginPop && (window.LoginPop.destroy(), window.LoginPop = null, $('#passport-login-pop').remove()), window.LoginPop = window.passport.pop.init({
                apiOpt: {
                    staticPage: e,
                    product: 'open_audio',
                    u: this.obj.goUrl,
                ...
                cache: !0,
                img: window.$CONFIG['paths.static'] + 'common/img/login_pop.png',
                authsite: [''],
                tangram: !0,
                onLoginSuccess: function (e) {
                    t.obj.callback && t.obj.callback.apply(t, e);
                }
            });
        }
    }), t;
}), define('common/widget/userlog/userlog', ['require'], function (e) {
    return window.USER_LOG = {
        send: function (e) {
            var t = e.url || window.$CONFIG['paths.base'] + 'log/linkClick';
            $.ajax({
                url: t + '?t=' + (new Date() - 0),
                type: e.type || 'get',
                cache: !1,
    ...
    }, $('body').on('click', '[data-user-log]', function () {
        var e = $(this).attr('data-user-log');
        e && window.USER_LOG.send({
            type: 'post',
            data: { keyWord: e }
        });
    }), window.USER_LOG;
}), define('common/widget/fixedzone/fixedzone', ['require'], function (e) {
    return {};
}), require([
    'common/widget/loginpop/loginpop',
    'common/widget/userlog/userlog',
    'common/widget/fixedzone/fixedzone'
], function (e, t, n) {
